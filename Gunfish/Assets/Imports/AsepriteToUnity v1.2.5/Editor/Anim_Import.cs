    ...
    public class Anim_Import : EditorWindow {
        ...
        void ExtractGUI() {
            ...
            if (EditorPrefs.GetBool(extractFoldout)) {
                ...
                GUILayout.Space(5);
UnityEngine.Debug.Log(EditorPrefs.GetString(asepriteExeLoc) + "aseprite.exe");
UnityEngine.Debug.Log(File.Exists(EditorPrefs.GetString(asepriteExeLoc) + "aseprite.exe"));
